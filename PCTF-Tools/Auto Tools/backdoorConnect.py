...
'''------------------------------------------------------------------------------------------------------------------
 ' Automated tool to connect to our backdoor to grab and submit flags for final - Project CTF
 '
 ' Group:	Black Shadow
 ' Team:	9
 ...
 '
 '
 ' Description: This application will connect to backdoor application implanted on victim machine and continously
 '		submit flags every tick.
 '
 '
-----------------------------------------------------------------------------------------------------------------'''
